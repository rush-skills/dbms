...
class PrerequisitesControllerTest < ActionController::TestCase
  ...
  test "should create prerequisite" do
    assert_difference('Prerequisite.count') do
      post :create, prerequisite: { course_id: @prerequisite.course_id, prerequisite_id: @prerequisite.prerequisite_id }
    end
  ...
  test "should update prerequisite" do
    patch :update, id: @prerequisite, prerequisite: { course_id: @prerequisite.course_id, prerequisite_id: @prerequisite.prerequisite_id }
    assert_redirected_to prerequisite_path(assigns(:prerequisite))
  end
