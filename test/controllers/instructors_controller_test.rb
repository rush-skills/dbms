...
class InstructorsControllerTest < ActionController::TestCase
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post :create, instructor: { department_id: @instructor.department_id, identification_number: @instructor.identification_number, name: @instructor.name, title: @instructor.title }
    end
  ...
  test "should update instructor" do
    patch :update, id: @instructor, instructor: { department_id: @instructor.department_id, identification_number: @instructor.identification_number, name: @instructor.name, title: @instructor.title }
    assert_redirected_to instructor_path(assigns(:instructor))
  end
